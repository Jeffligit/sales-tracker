class InventoryItem {
    ...
    /*
        Description: compares the date of the current inventoryItem to another one
        Input: InventoryItem Object
    ...
    */
    ...
    compareDateTo(otherInventoryItem) {
        var otherDate = otherInventoryItem.date;
