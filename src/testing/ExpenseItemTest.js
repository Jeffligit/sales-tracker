...
function makeNewExpenseItem() {
    const item = new ExpenseItem("10/10/2021", "Some Item Name", 3, 9.99);
...
function testCompareDateTo() {
    const item1 = new ExpenseItem("Unknown", "Some Item Name", 3, 9.99);
    const item2 = new ExpenseItem("Unknown", "Some Item Name", 3, 9.99);
